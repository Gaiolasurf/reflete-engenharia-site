...
const updateContent = () => {
    ...
    document.querySelector(".info-card:nth-child(1) h3").innerHTML = t.address;
    document.querySelector(".info-card:nth-child(1) p").innerHTML = t.addressText;
    document.querySelector(".info-card:nth-child(2) h3").innerHTML = t.phone;
    document.querySelector(".info-card:nth-child(3) h3").innerHTML = t.email;
    document.querySelector(".info-card:nth-child(4) h3").innerHTML = t.cnpj;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".servico-categoria, .projeto-card, .info-card").forEach(el => {
        el.style.opacity = "0";
        observer.observe(el);
    });
